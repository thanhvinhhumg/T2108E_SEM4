 ...
 * generated in the example.com.spring.soap package. 
...
public class ObjectFactory {
    ...
    private final static QName _AddCustomerResponse_QNAME = new QName("http://com.example/spring/soap", "addCustomerResponse");
    private final static QName _AddCustomer_QNAME = new QName("http://com.example/spring/soap", "addCustomer");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: example.com.spring.soap
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com.example/spring/soap", name = "addCustomerResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com.example/spring/soap", name = "addCustomer")
